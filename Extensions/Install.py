...
from Products.UWOshHomecomingSimple.config import PROJECTNAME
from Products.UWOshHomecomingSimple.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install UWOshHomecomingSimple """
    out = StringIO()
    ...
    try:
        from Products.UWOshHomecomingSimple.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    factory_types=[
        "HomecomingSignupSheet",
        "HomecomingTeam",
        ] + factory_tool.getFactoryTypes().keys()
    factory_tool.manage_setPortalFactoryTypes(listOfTypeIds=factory_types)

    from Products.UWOshHomecomingSimple.config import STYLESHEETS
    try:
        ...
        pass
    from Products.UWOshHomecomingSimple.config import JAVASCRIPTS
    try:
